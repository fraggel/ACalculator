package es.fraggel.acalculator.Services;
...
public class DataContext extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tblMessages = "create table if not exists Messages (FromMail text, ToMail text, Message text, SentDate text,urlImagen,urlVideo);";
